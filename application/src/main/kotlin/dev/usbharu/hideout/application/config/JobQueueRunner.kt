...
package dev.usbharu.dev.usbharu.hideout.application.config
...
class JobQueueRunner(
    ...
    companion object {
        val LOGGER: Logger =
            LoggerFactory.getLogger(JobQueueRunner::class.java)
    }
}
...
class JobQueueWorkerRunner(
    ...
    companion object {
        val LOGGER: Logger =
            LoggerFactory.getLogger(JobQueueWorkerRunner::class.java)
    }
}
